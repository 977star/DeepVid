...
[![Platform](https://img.shields.io/badge/platform-macOS%20%7C%20Apple%20Silicon-orange.svg?style=flat-square)](https://github.com/977star/DeepVid/releases)
...
| 功能模块 | 亮点解析 |
| :--- | :--- |
| **🎬 全能音视频源解析** | 原生支持哔哩哔哩 (Bilibili)、YouTube、抖音、小红书以及本地 MP4/MOV/MP3/M4A 拖拽解析。 |
| **🧠 精读双管线架构** | 🔥 **全局连贯直出 (One-Pass Stream · 首选推荐)** 与 ⚡ **分步精细萃取 (Two-Step Modular)** 自由切换，深度释放 **DeepSeek 128k 超大上下文** 潜力。 |
| **🌈 高保真 Callouts** | 原生支持 `ℹ️ 核心提示`、`💡 技巧建议`、`📌 关键重点`、`⚠️ 注意事项`、`🚨 避坑预警`、`🔥 高危风险` 等多色毛玻璃卡片，支持中英文自适应。 |
| **📸 实拍关键帧图文混排** | 毫秒级精准抽帧，图文并茂，完美还原专栏杂志级阅读质感。 |
...
1. 前往 **[Releases 页面](https://github.com/977star/DeepVid/releases)** 下载最新的 `DeepVid_1.9.0_aarch64.dmg`；
