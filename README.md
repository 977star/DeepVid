...
| 操作系统 | 下载文件 | 说明 |
| :--- | :--- | :--- |
| 🍏 **macOS (苹果芯片)** | `DeepVid_2.2.6_aarch64.dmg` | 适用于 M1 / M2 / M3 / M4 系列 Mac |
| 🪟 **Windows (64位)** | `DeepVid_2.2.6_x64-setup.exe` | 适用于 Windows 10 / 11 64位系统 |
...
> 💡 苹果 Gatekeeper 门禁对所有开源未签名软件的默认拦截。
...
- **方法一**：  
  ...
  ```
- **方法二**：  
  安装后，**按住键盘 `Control` 键不放，鼠标右键点击知影图标 ➔ 点击「打开」➔ 在弹窗中再次点击「打开」**。
